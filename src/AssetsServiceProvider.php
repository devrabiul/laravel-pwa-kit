...
class AssetsServiceProvider extends ServiceProvider
{
    ...
    {
        $this->handleVersionedPublishing(name: 'devrabiul/laravel-pwa-kit');
    }
     ...
     * - Registers a singleton instance of the PwaKit class in the Laravel service container.
     *
     * This allows other parts of the application to resolve the 'PwaKit' service.
     *
     * @return void
     */
